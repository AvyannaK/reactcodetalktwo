...
// Import useState from react in order to "hook" into the state of our components
import { useState } from "react";

const DiagramHooksExample = () => {
  // Here hook into the state and set the initial state to zero
  const [count, setCount] = useState(0);

  // Then create a click function to update the state with "setState" to a number higher with each click
  ...
  return (
    <div>
      ...
      {/* Finally, when rendering this code we will set the count variable and give it the onClick function */}
...
// Hooks are beneficial as they simplify state management, 
// promote code reuse, improve code readability, support functional programming,
// and work well with existing code. 



// Can Hooks be used in class components?

// They cannot be used directly in class components,
// which have their own state management and lifecycle methods. 

// What other hooks are available other than useState and useEffect?

// Apart from useState and useEffect are the followung:
